...
export const SLIDES = [
  ...
  /* 2 — MYTHS grid */
  {
    ...
    cards: [
      ...
      { modal: 'myth-renting',        title: 'Renting is always cheaper' },
  ...
  /* 3 — MYTH deep dive: closing costs & APR */
  {
    id: 'myth-closing-apr', layout: 'points', bg: 'dark', footer: true, hasNumbers: true,
    eyebrow: 'The myth',
    headline: 'The lowest rate is the best deal',
    subhead: 'The rate is one number. Closing costs quietly move the one that actually compares loans — the APR.',
    points: [
      'A lower rate is often <strong>bought</strong> with points and fees paid at closing',
      '<strong>APR folds those costs back in</strong> — it\'s the rate plus certain lender charges over the life of the loan',
  ...
  /* 4 — BUDGET: rent vs buy / cost of waiting */
  {
    ...
    left:  { label: 'Renting', items: [
      'Rent in Denver has trended <strong>up</strong>, year after year',
      'Flexible — but every payment builds someone else\'s equity',
      'The longer you wait, the <strong>further ahead prices get</strong>',
    ]},
    right: { label: 'Buying', items: [
      'A fixed payment while <strong>home values generally appreciate</strong>',
      'Equity compounds; you\'re paying yourself',
      'Most people <strong>step up</strong> — the first home isn\'t the last',
    ]},
  ...
  /* 5 — BUDGET: the payment (combined) */
  {
    ...
    points: [
      '<strong>Escrow</strong> collects a slice of taxes and insurance each month and pays them for you — not a fee, your money held early',
  ...
  /* 6 — BUDGET: comfort zone */
  {
    ...
    time: 150,
    notes: 'A lender determines whether you\'ll repay — that\'s the only question the guidelines ask. Nobody in the transaction is asking "will you be okay." So you have to. On builder incentives: a big incentive can mean you paid near full price for a home whose resale reflects the neighborhood — sell early and you owe more than it brings.',
  },
  ...
  /* 9 — CASH TO CLOSE: makeup */
  {
    ...
    points: [
      'You can use <strong>points</strong> to buy down the rate — or credits to cover closing costs',
