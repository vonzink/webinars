/* H-25(G): CFPB refinance Closing Disclosure sample where the borrower must
   BRING cash to consummation — the payoffs grew past the loan amount. Same
   template as H-25(E); values from the H-25(G) source PDF. Its Payoffs and
   Payments table itemizes four payoffs, the strongest cash-out teaching
   moment in the set. */
...
const pageHotspots = (pageNumber, entries) => entries.map((entry, index) => Object.freeze({
  id: `cd3.p${pageNumber}.${entry[0]}`,
  documentId: 'cd',
  pageId: `cd3-${pageNumber}`,
...
const CD3_PAGE_1 = pageHotspots(1, [
  ...
  ['lender', [0.3725, 0.1640, 0.3039, 0.0189], 'Lender', 'Fir Bank'],
  ...
  ['interest-rate', [0.0686, 0.3131, 0.4510, 0.0253], 'Interest Rate', '4.125%'],
  ['monthly-principal-interest', [0.0686, 0.3434, 0.4510, 0.0543], 'Monthly Principal and Interest', '$726.97'],
  ...
  ['projected-principal-interest', [0.0792, 0.5745, 0.7353, 0.0239], 'Projected Principal and Interest', '$726.97 in years 1–4 and years 5–30'],
  ...
  ['estimated-total-monthly-payment', [0.0792, 0.6705, 0.7353, 0.0328], 'Estimated Total Monthly Payment', '$1,015.45 in years 1–4; $933.10 in years 5–30'],
  ['estimated-taxes-insurance-assessments', [0.0686, 0.7260, 0.3317, 0.0492], 'Estimated Taxes, Insurance, and Assessments', '$206.13 a month'],
  ...
  ['closing-costs', [0.0686, 0.8554, 0.8235, 0.0379], 'Closing Costs', '$6,156.60'],
  ['cash-to-close', [0.0686, 0.9009, 0.8235, 0.0265], 'Cash to Close', '$6,716.60 from borrower'],
]);

const CD3_PAGE_2 = pageHotspots(2, [
  ['a-total', [0.0637, 0.0840, 0.8742, 0.0164], 'A. Origination Charges', '$2,250.00 borrower-paid', 'cd-a-total'],
  ['b-total', [0.0637, 0.2000, 0.8742, 0.0177], 'B. Services Borrower Did Not Shop For', '$620.00 borrower-paid', 'cd-b-total'],
  ['c-total', [0.0637, 0.3414, 0.8742, 0.0177], 'C. Services Borrower Did Shop For', '$930.50 borrower-paid', 'cd-c-total'],
  ['d-total', [0.0637, 0.4575, 0.8742, 0.0177], 'D. Total Loan Costs', '$3,800.50 borrower-paid', 'cd-d-total'],
  ['loan-costs-subtotals', [0.0637, 0.4726, 0.8742, 0.0177], 'Loan Costs Subtotals', '$3,360.50 at closing; $440.00 before closing', 'cd-loan-costs-subtotals'],
  ['e-total', [0.0637, 0.5200, 0.8742, 0.0177], 'E. Taxes and Other Government Fees', '$80.00 borrower-paid at closing', 'cd-e-total'],
  ['f-total', [0.0637, 0.5604, 0.8742, 0.0177], 'F. Prepaids', '$2,199.15 borrower-paid at closing', 'cd-f-total'],
  ...
  ['i-total', [0.0637, 0.8711, 0.8742, 0.0177], 'I. Total Other Costs', '$2,856.10 borrower-paid', 'cd-i-total'],
  ['j-total', [0.0637, 0.9173, 0.8742, 0.0177], 'J. Total Closing Costs', '$6,156.60 borrower-paid', 'cd-j-total'],
  ['lender-credits', [0.0637, 0.9438, 0.8742, 0.0164], 'Lender Credits', 'minus $500.00'],
]);

const CD3_PAGE_3 = pageHotspots(3, [
  ...
  ['payoff-existing-loan', [0.0637, 0.0990, 0.8760, 0.0177], 'Payoff of Existing Loan', 'Rho Servicing; $124,000.00', 'payoffs-and-payments'],
  ['payoff-credit-card', [0.0637, 0.1369, 0.8760, 0.0177], 'Credit Card Balance Paydown', 'Beta Card Inc.; $5,000.00', 'payoffs-and-payments'],
  ['payoff-mechanics-lien', [0.0637, 0.1748, 0.8760, 0.0177], 'Mechanic’s Lien Payoff', 'Bob’s Home Improvement; $12,000.00', 'payoffs-and-payments'],
  ['payoff-tax-lien', [0.0637, 0.2126, 0.8760, 0.0177], 'Tax Lien Payoff', 'State of Anywhere; $10,000.00', 'payoffs-and-payments'],
  ['k-total', [0.0637, 0.6595, 0.8760, 0.0189], 'K. Total Payoffs and Payments', '$151,000.00', 'total-payoffs-payments'],
  ['alt-loan-amount', [0.0637, 0.7659, 0.8760, 0.0177], 'Loan Amount', 'Loan Estimate and final $150,000.00; no change', 'loan-amount'],
  ['cash-total-closing-costs', [0.0637, 0.7861, 0.8760, 0.0177], 'Total Closing Costs', 'Loan Estimate minus $5,691.00; final minus $6,156.60; changed', 'cd-cash-total-closing-costs'],
  ['closing-costs-paid-before-closing', [0.0637, 0.8063, 0.8760, 0.0177], 'Closing Costs Paid Before Closing', 'Loan Estimate $0; final $440.00; changed'],
  ['total-payoffs-payments', [0.0637, 0.8266, 0.8760, 0.0177], 'Total Payoffs and Payments', 'Loan Estimate minus $120,000.00; final minus $151,000.00; changed', 'total-payoffs-payments'],
  ['cash-to-close', [0.0637, 0.8442, 0.8760, 0.0189], 'Cash to Close', 'Loan Estimate $24,309.00 to borrower; final $6,716.60 from borrower'],
  ['closing-costs-financed', [0.0637, 0.8707, 0.8760, 0.0177], 'Closing Costs Financed', '$5,691.00 paid from the loan amount', 'cd-closing-costs-financed'],
]);

const CD3_PAGE_4 = pageHotspots(4, [
  ...
  ['non-escrowed-property-costs', [0.5212, 0.3043, 0.4167, 0.0631], 'Non-Escrowed Property Costs over Year 1', 'No amount shown'],
...
const CD3_PAGE_5 = pageHotspots(5, [
  ['total-payments', [0.0650, 0.0745, 0.4134, 0.0442], 'Total of Payments', '$269,574.50'],
  ['finance-charge', [0.0650, 0.1313, 0.4134, 0.0316], 'Finance Charge', '$116,884.00'],
  ['amount-financed', [0.0650, 0.1755, 0.4134, 0.0316], 'Amount Financed', '$148,367.91'],
  ['apr', [0.0650, 0.2197, 0.4134, 0.0442], 'Annual Percentage Rate', '4.404%'],
  ['tip', [0.0650, 0.2753, 0.4134, 0.0442], 'Total Interest Percentage', '74.66%'],
  ...
  ['lender-contact', [0.2660, 0.5700, 0.2200, 0.2600], 'Lender Contact', 'Fir Bank; Joe Smith; 123-456-7890'],
...
export const CD3_HOTSPOTS = Object.freeze([
  ...CD3_PAGE_1,
  ...CD3_PAGE_2,
  ...CD3_PAGE_3,
  ...CD3_PAGE_4,
