...
/* VA payment makeup — note there is NO monthly mortgage insurance line;
   that absence is the teaching point on the payment slide. */
export const PAY_SEGMENTS = [
  { label: 'Principal', w: 24, fill: 'var(--pay-principal)' },
  { label: 'Interest',  w: 34, fill: 'var(--pay-interest)' },
  { label: 'Taxes',     w: 19, fill: 'var(--pay-taxes)' },
  { label: 'Insurance', w: 13, fill: 'var(--pay-insurance)' },
  { label: 'HOA',       w: 10, fill: 'var(--pay-hoa)' },
];
